...
static size_t cal_rt_frame_size(void)
{
	...
	size_t sc_extn_size = sizeof(frame->uc.uc_mcontext.sc_extn);
	...
	if (total_context_size > sc_extn_size)
		frame_size += (total_context_size - sc_extn_size);
